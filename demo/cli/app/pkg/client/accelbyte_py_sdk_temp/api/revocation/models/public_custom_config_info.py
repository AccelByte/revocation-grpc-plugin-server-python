...
class PublicCustomConfigInfo(Model):
    ...
    def with_connection_type(self, value: Union[str, ConnectionTypeEnum]) -> PublicCustomConfigInfo:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PublicCustomConfigInfo:
        instance = cls()
        if not dict_:
            return instance
        ...
        if "tlsConfig" in dict_ and dict_["tlsConfig"] is not None:
            instance.tls_config = BaseTLSConfig.create_from_dict(dict_["tlsConfig"], include_empty=include_empty)
        elif include_empty:
            instance.tls_config = BaseTLSConfig()
        return instance

    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, PublicCustomConfigInfo]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[PublicCustomConfigInfo]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[PublicCustomConfigInfo, List[PublicCustomConfigInfo], Dict[Any, PublicCustomConfigInfo]]:
        if many:
