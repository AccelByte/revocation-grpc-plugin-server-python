...
class GetLootBoxGrpcInfo(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/catalog/plugins/lootbox/grpcInfo"
    _method: str = "GET"
    _consumes: List[str] = []
    _produces: List[str] = []
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, GrpcServerInfo], Union[None, HttpResponse]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetLootBoxGrpcInfo:
        instance = cls()
