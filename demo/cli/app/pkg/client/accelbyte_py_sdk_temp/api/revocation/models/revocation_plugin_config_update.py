...
class RevocationPluginConfigUpdate(Model):
    ...
    def with_extend_type(self, value: Union[str, ExtendTypeEnum]) -> RevocationPluginConfigUpdate:
    ...
    def with_custom_config(self, value: BaseCustomConfig) -> RevocationPluginConfigUpdate:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "custom_config"):
            result["customConfig"] = self.custom_config.to_dict(include_empty=include_empty)
        elif include_empty:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RevocationPluginConfigUpdate:
        instance = cls()
        if not dict_:
            return instance
        ...
        if "appConfig" in dict_ and dict_["appConfig"] is not None:
            instance.app_config = AppConfig.create_from_dict(dict_["appConfig"], include_empty=include_empty)
        elif include_empty:
            instance.app_config = AppConfig()
        if "customConfig" in dict_ and dict_["customConfig"] is not None:
            instance.custom_config = BaseCustomConfig.create_from_dict(dict_["customConfig"], include_empty=include_empty)
        elif include_empty:
            instance.custom_config = BaseCustomConfig()
        return instance

    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, RevocationPluginConfigUpdate]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[RevocationPluginConfigUpdate]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[RevocationPluginConfigUpdate, List[RevocationPluginConfigUpdate], Dict[Any, RevocationPluginConfigUpdate]]:
        if many:
