...
class RevocationPluginConfigInfo(Model):
    ...
    def with_custom_config(self, value: PublicCustomConfigInfo) -> RevocationPluginConfigInfo:
        self.custom_config = value
        return self

    def with_extend_type(self, value: Union[str, ExtendTypeEnum]) -> RevocationPluginConfigInfo:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RevocationPluginConfigInfo:
        instance = cls()
        if not dict_:
            return instance
        ...
        if "customConfig" in dict_ and dict_["customConfig"] is not None:
            instance.custom_config = PublicCustomConfigInfo.create_from_dict(dict_["customConfig"], include_empty=include_empty)
        elif include_empty:
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, RevocationPluginConfigInfo]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[RevocationPluginConfigInfo]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[RevocationPluginConfigInfo, List[RevocationPluginConfigInfo], Dict[Any, RevocationPluginConfigInfo]]:
        if many:
