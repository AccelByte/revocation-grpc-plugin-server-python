...
class QueryChanges(Operation):
    ...
    **kwargs
    ...
    def get_enum_map() -> Dict[str, List[Any]]:
        return {
            "action": ["CREATE", "UPDATE", "DELETE"],                                              # in query
            "itemType": ["APP", "COINS", "INGAMEITEM", "BUNDLE", "CODE", "SUBSCRIPTION", "SEASON", "MEDIA", "OPTIONBOX", "EXTENSION", "LOOTBOX"],# in query
            "status": ["UNPUBLISHED", "PUBLISHED"],                                                # in query
            "type": ["STORE", "CATEGORY", "ITEM", "VIEW", "SECTION"],                              # in query
        }
