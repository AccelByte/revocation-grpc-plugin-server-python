    ...
    **kwargs
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> TLSConfig:
        ...
        if "rootCertFileBytes" in dict_ and dict_["rootCertFileBytes"] is not None:
            instance.root_cert_file_bytes = [str(i0) for i0 in dict_["rootCertFileBytes"]]
        elif include_empty:
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, TLSConfig]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[TLSConfig]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[TLSConfig, List[TLSConfig], Dict[Any, TLSConfig]]:
        if many:
