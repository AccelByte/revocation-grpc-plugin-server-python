...
class UpdateLootBoxPluginConfig1(Operation):
    ...
    def with_body(self, value: RevocationPluginConfigUpdate) -> UpdateLootBoxPluginConfig1:
        self.body = value
        return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, RevocationPluginConfigInfo], Union[None, HttpResponse, ValidationErrorEntity]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateLootBoxPluginConfig1:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = RevocationPluginConfigUpdate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
