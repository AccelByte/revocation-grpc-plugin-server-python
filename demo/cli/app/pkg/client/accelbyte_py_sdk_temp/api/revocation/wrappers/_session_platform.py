...
def register_xbl_sessions(user_id: str, body: Optional[XblUserSessionRequest] = None, namespace: Optional[str] = None, x_additional_headers: Optional[Dict[str, str]] = None, **kwargs):
...
@same_doc_as(RegisterXblSessions)
async def register_xbl_sessions_async(user_id: str, body: Optional[XblUserSessionRequest] = None, namespace: Optional[str] = None, x_additional_headers: Optional[Dict[str, str]] = None, **kwargs):
    """Register/Update a session (registerXblSessions)
