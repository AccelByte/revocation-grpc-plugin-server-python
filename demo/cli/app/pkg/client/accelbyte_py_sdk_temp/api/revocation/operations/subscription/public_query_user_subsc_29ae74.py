...
class PublicQueryUserSubscriptions(Operation):
    ...
    **kwargs
    ...
    def get_enum_map() -> Dict[str, List[Any]]:
        return {
            "chargeStatus": ["NEVER", "SETUP", "RECURRING_CHARGING", "CHARGED", "CHARGE_FAILED"],  # in query
            "status": ["INIT", "ACTIVE", "CANCELLED", "EXPIRED"],                                  # in query
            "subscribedBy": ["USER", "PLATFORM"],                                                  # in query
        }
