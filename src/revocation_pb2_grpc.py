...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in revocation_pb2_grpc.py depends on'
...
class RevocationServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_RevocationServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'accelbyte.platform.revocation.v1.Revocation', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('accelbyte.platform.revocation.v1.Revocation', rpc_method_handlers)
